...
@interface AdViewController ()<MPAdViewDelegate, MPInterstitialAdControllerDelegate, CLLocationManagerDelegate, RFMFastLaneDelegate>{
...
-(void)requestNewAd{
    ...
    if (self.adIsBanner) {
        ...
        self.fastlaneRequest = [[RFMAdRequest alloc] initRequestWithServer:@"http://mrp.rubiconproject.com/"
                                                                  andAppId:@"F2B0ABD0B7CF0133108722000B3510F7"
                                                                  andPubId:@"111315"];
